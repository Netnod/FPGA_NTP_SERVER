...
#
# ntp_clock.tcl: Tcl script for re-creating project 'ntp_clock'
#
# Generated by Vivado on Sun May 21 21:05:40 CEST 2017
...
#
# 1. This project restoration tcl script (ntp_clock.tcl) that was generated.
#
...
#    "/home/rolf/ntp_proj/trunk/FPGA/ntp_clock/tb/tb_ntp_clock.v"
...
set orig_proj_dir "[file normalize "$origin_dir/ntp_clock"]"

# Create project
create_project ntp_clock ./ntp_clock

# Set the directory path for the new project
set proj_dir [get_property directory [current_project]]

# Set project properties
set obj [get_projects ntp_clock]
...
set files [list \
 ...
 "[file normalize "$origin_dir/../hdl/ntp_counters.v"]"\
 "[file normalize "$origin_dir/../hdl/pll_sync.v"]"\
 "[file normalize "$origin_dir/../ip/ntp_clock_pll/ntp_clock_pll.xci"]"\
 "[file normalize "$origin_dir/../../network_path/hdl/time_sel_sync.v"]"\
 "[file normalize "$origin_dir/../tb/tb_ntp_clock.v"]"\
 "[file normalize "$origin_dir/../../xilinx/v7_xt_conn_trd/hardware/sources/hdl/common/synchronizer_vector.v"]"\
]
add_files -norecurse -fileset $obj $files

# Set 'sources_1' fileset file properties for remote files
set file "$origin_dir/../ip/ntp_clock_pll/ntp_clock_pll.xci"
...
set obj [get_filesets sources_1]
set_property "top" "tb_ntp_clock" $obj
...
puts "INFO: Project created:ntp_clock"
