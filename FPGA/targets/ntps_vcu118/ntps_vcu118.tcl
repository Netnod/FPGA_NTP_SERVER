...
#
# ntps_vcu118.tcl: Tcl script for re-creating project 'ntps_vcu118'
#
...
set _xil_proj_name_ "ntps_vcu118"
...
set script_file "ntps_vcu118.tcl"
...
# Create project
create_project -force ${_xil_proj_name_} . -part xcvu9p-flga2104-2L-e
...
set files [list \
 ...
 [file normalize "${origin_dir}/xilinx_ip/top/ntps_top_xdma_0/ntps_top_xdma_0.xci" ]\
]
...
set file "ntps_top_xdma_0/ntps_top_xdma_0.xci"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "generate_files_for_reference" -value "0" -objects $file_obj
if { ![get_property "is_locked" $file_obj] } {
  set_property -name "generate_synth_checkpoint" -value "0" -objects $file_obj
