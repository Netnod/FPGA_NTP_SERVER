#--------------------------------------------------------------------
# NTP clock A
set_property PACKAGE_PIN K40 [get_ports TEN_MHZ_INA_N]
set_property IOSTANDARD DIFF_HSTL_II_18 [get_ports TEN_MHZ_INA_P]
set_property IOSTANDARD DIFF_HSTL_II_18 [get_ports TEN_MHZ_INA_N]
create_clock -period 100.000 -name TEN_MHZ_INA_P -waveform {0.000 50.000} [get_ports TEN_MHZ_INA_P]
...
# FMC1_HPC_HB00_CC_N
set_property PACKAGE_PIN J26 [get_ports TEN_MHZ_INB_N]
set_property IOSTANDARD DIFF_HSTL_II_18 [get_ports TEN_MHZ_INB_P]
set_property IOSTANDARD DIFF_HSTL_II_18 [get_ports TEN_MHZ_INB_N]
create_clock -period 100.000 -name TEN_MHZ_INB_P -waveform {0.000 50.000} [get_ports TEN_MHZ_INB_P]
