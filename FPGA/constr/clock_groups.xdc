...
set_clock_groups -name async_userclks_clk156 -asynchronous -group [get_clocks userclk*] -group [get_clocks [get_clocks -of_objects [get_pins network_path_shared_0/ten_gig_eth_pcs_pma_inst/refclk_p]]]
