...
#
# project.tcl: Tcl script for re-creating project 'sha1'
#
# Generated by Vivado on Wed Feb 17 22:36:14 CET 2016
...
#    "/home/rolf/ntp_proj/trunk/FPGA/network_path/packet_proc/SHA1/tb/tb_sha1.v"
#    "/home/rolf/ntp_proj/trunk/FPGA/network_path/packet_proc/SHA1/tb/tb_sha1_pipe.v"
#
#*****************************************************************************************
...
set orig_proj_dir "[file normalize "$origin_dir/sha1"]"

# Create project
create_project sha1 ./sha1

# Set the directory path for the new project
set proj_dir [get_property directory [current_project]]

# Set project properties
set obj [get_projects sha1]
...
set files [list \
 "[file normalize "$origin_dir/../hdl/sha1_stage.v"]"\
 "[file normalize "$origin_dir/../hdl/sha1_pipe.v"]"\
 "[file normalize "$origin_dir/../ip/chunk_del/chunk_del.xci"]"\
 "[file normalize "$origin_dir/../ip/sum_del/sum_del.xci"]"\
 "[file normalize "$origin_dir/../hdl/sha1.v"]"\
]
add_files -norecurse -fileset $obj $files

# Set 'sources_1' fileset file properties for remote files
set file "$origin_dir/../ip/chunk_del/chunk_del.xci"
...
set file "$origin_dir/../ip/sum_del/sum_del.xci"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
if { ![get_property "is_locked" $file_obj] } {
  set_property "synth_checkpoint_mode" "Singular" $file_obj
...
set files [list \
 "[file normalize "$origin_dir/../tb/tb_sha1_func.sv"]"\
 "[file normalize "$origin_dir/../tb/tb_sha1.v"]"\
 "[file normalize "$origin_dir/../tb/tb_sha1_pipe.v"]"\
]
add_files -norecurse -fileset $obj $files

# Set 'sim_1' fileset file properties for remote files
set file "$origin_dir/../tb/tb_sha1_func.sv"
set file [file normalize $file]
...
puts "INFO: Project created:sha1"
